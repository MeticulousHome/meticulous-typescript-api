...
export default class Api {
    ...
    createReport(request?: CreateReportRequest, options?: CreateReportOptions): Promise<ReportResult<DraftInfo>>;
    getReports(pageParams: PageParams): Promise<ReportResult<PaginatedResponse<ReportInfo>>>;
    getDraftReport(localID: string): Promise<ReportResult<Uint8Array>>;
    deleteDraftReport(localID: string): Promise<ReportResult<void>>;
    updateReport(id: string, patch: Partial<ReportInfo>): Promise<ReportResult<ReportInfo>>;
    markSubmittedReport(submitInfo: SubmitInfo): Promise<ReportResult<void>>;
    getMeticulousReportTracking(serviceUrl: string, payload: MeticulousIDRequestType): Promise<ReportResult<number>>;
