...
export type ActionType = 'start' | 'stop' | 'continue' | 'reset' | 'tare' | 'preheat' | 'calibration' | 'scale_master_calibration';
...
export declare const LIMITED_ACCESS_CHANNEL = "factory";
export declare const isLimitedAccess: (settings?: Pick<Settings, "update_channel"> | null) => boolean;
...
export type UnlockErrorCode = 'INVALID_BODY' | 'INVALID_UNLOCK_CODE' | 'UNLOCK_THROTTLED';
...
export interface WifiStatus {
    ...
    known_wifis: {
        [key: string]: WiFiCredentials | string;
    };
}
...
export type ReportErrorCode = 'INVALID_BODY' | 'INVALID_LOCAL_ID' | 'UNKNOWN_LOCAL_ID' | 'FORBIDDEN_UPDATE' | 'COLLECTION_IN_PROGRESS' | 'INSUFFICIENT_DISK_SPACE' | 'INTERNAL';
export type PreflightBlocker = 'NO_SERIAL_NUMBER' | 'INSUFFICIENT_DISK_SPACE' | 'COLLECTION_IN_PROGRESS' | 'NETWORK_UNREACHABLE';
...
export type ProfileEvent = 'create' | 'update' | 'delete' | 'full_reload' | 'load';
