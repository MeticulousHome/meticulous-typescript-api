...
class Api {
    ...
    async createReport(request) {
        try {
            ...
            const response = request
                ? await this.axiosInstance.post(`/api/${this.version}/reports/create`, request, config)
                : await this.axiosInstance.post(`/api/${this.version}/reports/create`, undefined, config);
    ...
    async getReports(pageParams) {
        try {
            const response = await this.axiosInstance.get(`/api/${this.version}/reports/list`, {
                headers: {
                    Accept: 'application/json'
                },
                params: pageParams
    ...
    async getDraftReport(localID) {
        try {
            const response = await this.axiosInstance.get(`/api/${this.version}/reports/draft/${localID}`, {
                headers: {
    ...
    async deleteDraftReport(localID) {
        try {
            const response = await this.axiosInstance.delete(`/api/${this.version}/reports/draft/${localID}`, {
                headers: {
                    Accept: 'application/json'
                }
            });
    ...
    async updateReport(id, patch) {
        try {
            ...
            const response = await this.axiosInstance.put(`/api/${this.version}/reports/draft/${id}`, normalizedReport, {
                headers: {
                    Accept: 'application/json'
                }
            });
    ...
    async markSubmittedReport(submitInfo) {
        try {
            const response = await this.axiosInstance.post(`/api/${this.version}/reports/submit`, submitInfo, {
                headers: {
                    Accept: 'application/json'
                }
            });
    ...
    async getMeticulousReportTracking(serviceUrl, payload) {
        try {
            const response = await axios_1.default.post(serviceUrl, payload, {
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json'
                }
